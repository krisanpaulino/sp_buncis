        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a href="<?= base_url('admin/petani') ?>">Petani</a></li>
    ...
    <div class="container">
        <div class="main-body">
            <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                    <form action="<?= base_url('admin/petani/update') ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="col-lg-8">
                    <form action="<?= base_url('admin/petani/update') ?>" method="post">
                        <div class="card">
                            <div class="card-body">
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="<?= base_url('admin/petani/reset-password') ?>" method="post">
                                        <div class="row">
                                            <div class="col-sm-3"></div>
                                            <div class="col-sm-9 text-secondary">
