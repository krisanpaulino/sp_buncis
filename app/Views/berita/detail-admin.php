        ...
        <div class="card-body">
            ...
            <form action="<?= base_url('admin/berita/update') ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group mb-4">
                    ...
                    <textarea rows="10" cols="80" id="editor1" name="berita_isi"><?= old('berita_isi', $berita->berita_isi) ?></textarea>
                    <div class="invalid-feedback">
                ...
                <div class="form-group mb-4">
                    <label for="file">Thumbnail Berita (Dikosongkan jika tidak ada perubahan)</label>
